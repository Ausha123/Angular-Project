...
@Component({
  selector: 'app-system-development-main-slider',
  templateUrl: './system-development-main-slider.component.html',
  styleUrls: ['./system-development-main-slider.component.scss']
})
export class SystemDevelopmentMainSliderComponent implements OnInit {
